...
src/%.o: ../src/%.c
	...
	arm-none-eabi-gcc -DDEBUG -D__CODE_RED -D__REDLIB__ -I"../../Lib_CMSISv1p30_LPC17xx/inc" -I"../../Lib_MCU/inc" -O0 -g3 -Wall -c -fmessage-length=0 -fno-builtin -ffunction-sections -mcpu=cortex-m3 -mthumb -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
